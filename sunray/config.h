...
#define WHEEL_BASE_CM         35         // wheel-to-wheel distance (cm)        
...
// Egen siffra baserat på hur många varv den snurrar vid AT+E test (ska vara 10 varv)
// #define TICKS_PER_REVOLUTION 868 / 2
 #define TICKS_PER_REVOLUTION 4125 / 11
